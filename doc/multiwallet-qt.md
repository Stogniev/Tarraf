...
Only requiring some minor changes is TRF.cpp.
...
Changes to TRF.cpp
----------------------
TRF.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
