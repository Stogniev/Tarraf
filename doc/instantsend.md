...
This mechanism has been integrated into Bitcore-Node-TRF which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/TRFpay/insight-api-TRF#web-socket-api](https://github.com/TRFpay/insight-api-TRF#web-socket-api) 
* API: [https://github.com/TRFpay/insight-api-TRF#instantsend-transactions](https://github.com/TRFpay/insight-api-TRF#instantsend-transactions) 
...
By default, the TRF Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the TRF Core daemon:
