 ...
 *
 *   // network
 *   CTRFNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.TRF.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CTRFNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: TRFNetwork
// //   -- signature requirements : Key1(User)
// class CTRFNetworkVariable : public CGovernanceObject
// {
// private:
