    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("TRF Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About TRF Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  TRF-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the TRF in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 TRF, 0.1 TRF, 1 TRF and 10 TRF -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://TRFpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://TRFpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("TRF Core is shutting down...") + "<br /><br />" +
