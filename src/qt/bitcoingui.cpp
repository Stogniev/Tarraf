    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("TRF Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TRF address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and TRF: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About TRF Core"), this);
    aboutAction->setStatusTip(tr("Show information about TRF Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TRF Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TRF addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TRF addresses"));
    ...
    openAction->setStatusTip(tr("Open a TRF: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TRF Core help message to get a list with possible TRF Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("TRF Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TRF network", "", count));
}
...
{
    QString strTitle = tr("TRF Core"); // default title
