    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("TRF-light"), QVariant("light"));
    ui->theme->addItem(QString("TRF-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("TRF-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("TRF-traditional"), QVariant("trad"));
